                    ...
                    {messages.length === 0 && (
                        <div className="h-full flex flex-col items-center justify-center text-center p-8 animate-in fade-in zoom-in-95 duration-700">
                            ...
                            <p className="text-slate-500 max-w-md text-lg leading-relaxed mb-10">
                                I can analyze e-commerce sales, customers, returns, inventory, and marketing data to help you find real insights.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl w-full">
                                {[
                                    { t: "Revenue Trend", q: "Show the monthly revenue trend for 2023" },
                                    { t: "Return Hotspots", q: "Which product categories have the highest return rate?" },
                                    { t: "Payment Habits", q: "What's the most common payment method, and what percentage of transactions use it?" },
                                    { t: "Just Curious", q: "What's the weather like in Tokyo today?" }
                                ].map((item) => (
                                    <button
                                        key={item.q}
